 ...
 */
public class PotentialFieldMatrixLayer<E> extends MatrixLayer implements Updateable
{
	 ...
	 */
	public PotentialFieldMatrixLayer(LayerDimension dimension)
	{
		super(dimension);
	...
	public void update()
	{
		...
		Set<LayerPoint> borderPoints = FloodFillProcessor.defillGradient(this, 0, defillPoints);
