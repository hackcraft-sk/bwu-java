...
public class Graphics {
	...
	public void drawBox(Vector2D topLeftCorner, Vector2D bottomRightCorner) {
		bot.BWAPI.drawBox(
				new Position((int)Math.round(topLeftCorner.x), (int)Math.round(topLeftCorner.y)),
				new Position((int)Math.round(bottomRightCorner.x), (int)Math.round(bottomRightCorner.y)),
				color, false, screen);
	}
	...
	public void drawLine(Vector2D from, Vector2D to) {
		bot.BWAPI.drawLine(
				new Position((int)Math.round(from.x), 
				(int)Math.round(from.y)), 
				new Position((int)Math.round(to.x), 
				(int)Math.round(to.y)), 
				color, screen);
	}
